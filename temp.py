...
def train_perceptron_model(X, y, dataset):
...
def train_logistic_regression(X, y, dataset):
...
def main():
    ...
    perceptron = train_perceptron_model(X_train, y_train, dataset)
    logreg = train_logistic_regression(X_train, y_train, dataset)
